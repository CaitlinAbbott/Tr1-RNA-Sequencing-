...
```{r plot-volcano-dnvlag3, fig.cap = "Volcano Plot for DN Vs. LAG3. The (up to) 10 most highly-ranked genes are labelled."}
top_tables$DNvLAG3 %>% 
...
```{r plot-volcano-dnvdp, fig.cap = "Volcano Plot for DN Vs. DP. The (up to) 10 most highly-ranked genes are labelled."}
top_tables$DNvDP %>% 
  ggplot(aes(logFC, -log10(P.Value))) +
  geom_point(aes(colour = DE), alpha = 0.6) +
  geom_label_repel(
...
```{r plot-volcano-dnvcd49, fig.cap = "Volcano Plot for DN Vs. CD49b. The (up to) 10 most highly-ranked genes are labelled."}
top_tables$DNvCD49b %>% 
  ggplot(aes(logFC, -log10(P.Value))) +
  geom_point(aes(colour = DE), alpha = 0.6) +
  geom_label_repel(
...
```{r plot-volcano-lag3vcd49, fig.cap = "Volcano Plot for LAG3 Vs. CD49b. The (up to) 10 most highly-ranked genes are labelled."}
top_tables$LAG3vCD49b %>% 
  ggplot(aes(logFC, -log10(P.Value))) +
  geom_point(aes(colour = DE), alpha = 0.6) +
  geom_label_repel(
...
```{r plot-volcano-lag3vdp, fig.cap = "Volcano Plot for LAG3 Vs. DP. The (up to) 10 most highly-ranked genes are labelled."}
top_tables$LAG3vDP %>% 
  ggplot(aes(logFC, -log10(P.Value))) +
  geom_point(aes(colour = DE), alpha = 0.6) +
  geom_label_repel(
...
```{r plot-volcano-cd49vdp, fig.cap = "Volcano Plot for CD49b Vs. DP. The (up to) 10 most highly-ranked genes are labelled."}
top_tables$CD49bvDP %>% 
  ggplot(aes(logFC, -log10(P.Value))) +
  geom_point(aes(colour = DE), alpha = 0.6) +
  geom_label_repel(
...
![Changes in relative expression for the top 100 DE genes by logFC. The same figure is available [here](assets/top100_fogfc_heat.pdf) as a pdf.](assets/top100_logfc_heat.png){width=300px}
